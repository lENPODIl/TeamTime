...
<body>
  ...
  <nav class="navbar navbar-expand-md bg-body-tertiary navbar-light">
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbar-toggler">
        ...
        <a href="seleccionE.php" class="btn-neon">
          <span id="span1"></span>
          <span id="span2"></span>
          <span id="span3"></span>
          <span id="span4"></span>
  ...
  <div class="container">
    <div class="card">
      ...
      <div class="card-body">
        <a class="btn btn-primary" href="agendarr.php" title="Crear nueva Oferta de Trabajo" role="button"><i class="fas fa-file" aria-hidden="true"></i> Nueva</a>
        <hr>
          ...
          <tbody>
            ...
            while ($datos = $sql->fetch_assoc()) { ?>
              <tr>
                ...
                <td>
                  <a href="../paginas/modificarCitasEmp.php?id=<?php echo $datos['id_cita']?>" class="btn btn-success btn-sm" role="button" title="Editar el registro."><i class="bi bi-pencil-square"></i></a>
                  <a href="../controlador/eliminarCitasEmp.php?id=<?php echo $datos['id_cita']?>" class="btn btn-success btn-sm confirmar" role="button" title="Eliminar el registro."><i class="bi bi-trash-fill"></i></a>
              </tr>
            <?php }
            ?>
