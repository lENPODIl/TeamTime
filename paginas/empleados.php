...
<head>
  ...
  <meta name="description" content="Agenda de empleados">
...
<body>
  ...
  <div class="container">
    <div class="card">
      <center><h4 class="card-header"><strong>Lista de empleados</strong></h4></center>
      <?php
      include "../controlador/eliminarEmp.php";
      ?>
      <div class="card-body">
        <a class="btn btn-primary" href="registrarEmpleados.php" title="Crear nueva Oferta de Trabajo" role="button"><i
        ...
        <table class="table table-hover">
          ...
          <tbody>
            ...
            <tr>
            <td hidden><?= $datos->id_empleado?></td>
              ...
              <td>
                <a href="../paginas/modificarE.php?id=<?= $datos->id_empleado?>" class="btn btn-success btn-sm btn-success" role="button" title="Editar el registro."><i class="bi bi-pencil-square"></i></a>
                <a href="../paginas/empleados.php?id=<?= $datos->id_empleado?>" class="btn btn-success btn-sm confirmar btn-danger" role="button" title="Eliminar el registro."><i class="bi bi-trash-fill"></i></a>
              </td>
            </tr>
            <?php }
            ?>
