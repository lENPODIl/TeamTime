  ...
  <nav class="navbar navbar-expand-md bg-body-tertiary navbar-light">
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbar-toggler">
        ...
        <a href="citas.php" class="btn-neon navbar-nav d-flex justify-content-center align-items-center">
          <span id="span1"></span>
          <span id="span2"></span>
          <span id="span3"></span>
          <span id="span4"></span>
      ...
      <a href="medicos.php" class="Centro-integrativo">
          ...
          <span id="span33"></span>
          <span id="span44"></span>
          <strong style="font-size: 20px;">REGISTRAR MEDICOS</strong>
      </a>
      <a href="empleados.php" class="proyectos">
          <span id="span111"></span>
          <span id="span222"></span>
          <span id="span333"></span>
          <span id="span444"></span>
          <strong style="font-size: 20px;">REGISTRAR EMPLEADOS</strong>
      </a>
