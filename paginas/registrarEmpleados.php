  ...
  <div class="container">
    <div class="card">
      ...
      <div class="card-body">
        <form method="post">
        <?php
       include "../controlador/registarPersona.php";
            ...
            <div class="col-md-3">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="descripcion" name="escolaridad"
                  placeholder="Escolaridad..." required="required">
              </div>
            </div>
            <div class="col-md-3">
              <div class="form-group">
                <label for="descripcion">Telefono en caso de emergencia</label>
            ...
            <div class="col-md-3">
              <div class="form-group">
                ...
                <input type="date" class="form-control" name="fecha" id="fecha"
                  placeholder="Fecha de contratación..." required="required" >
              </div>
            </div>
            <div class="col-md-9">
              <div class="form-group">
                <label for="fecha">Referencias</label>
                <input type="text" class="form-control" name="referencia" id="referencia" placeholder="Descripcion"
                required="required" >
              </div>
            </div>
          </div>
